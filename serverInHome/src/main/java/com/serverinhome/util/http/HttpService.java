...
public class HttpService {
    ...
    public static synchronized HttpService getInstance() throws Exception {
        if (_instance == null) {
    ...
    public HttpService(Properties props) throws Exception {
        this(new HttpConf(props));
    }

    public HttpService(HttpConf httpConf) throws Exception {
        _httpConf = httpConf;
