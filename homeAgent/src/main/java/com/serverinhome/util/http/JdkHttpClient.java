...
public class JdkHttpClient implements HttpClient {
    ...
    // ------------------------------------------------------------------------
    private static JdkHttpClient _instance = null;
    public static synchronized JdkHttpClient getInstance() throws Exception {
        if (_instance == null) {
            _instance = new JdkHttpClient();
        }
        return _instance;
    }
    
    public JdkHttpClient() throws Exception {
        this(new HttpConf());
    }

    public JdkHttpClient(Properties props) throws Exception {
        this(new HttpConf(props));
    }

    public JdkHttpClient(HttpConf httpConf) throws Exception {
        _httpConf = httpConf;
